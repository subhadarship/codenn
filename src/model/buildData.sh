...
python buildData.py python $MAX_CODE_LENGTH $MAX_NL_LENGTH $PYTHON_UNK_THRESHOLD $NL_UNK_THRESHOLD
...
th buildData.lua -language python -max_code_length $MAX_CODE_LENGTH -max_nl_length $MAX_NL_LENGTH -batch_size $BATCH_SIZE
